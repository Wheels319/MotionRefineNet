...
from lib.core.loss import MotionRefineNetLoss
from lib.models.motionrefine import MotionRefineNet
...
def main(cfg):
    ...
    # # ========= Compile Loss ========= #
    loss = MotionRefineNetLoss(w_accel=cfg.LOSS.W_ACCEL, w_pos=cfg.LOSS.W_POS)

    # # ========= Initialize networks ========= #
    model = MotionRefineNet(window_size=cfg.MODEL.SLIDE_WINDOW_SIZE,
    ...
    # input1 = torch.randn(128,51,64).cuda()
